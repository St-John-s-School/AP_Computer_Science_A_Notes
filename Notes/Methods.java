...
public class Methods{
    public static void main(String[] args)
    {
      ...
      First, we can think of them as mathematical functions, as in, they have inputs,
      and do something to them to produce an output of some kind.
  
      Second, we can think of methods as the building blocks of programs.
      Every Java program consists of multiple steps, or procedures, that are accomplished
      by individual methods. 
      For example, we might need to read in some values from a user, do some math with them,
      and print those out. Each of those individual steps in our procedure might be a method. 
      */
      ...
      1) Is a modifier that determines where our method can be used in our program.

         In this case, we made it "public" which allows
         for our method to be call-able in all parts of our program.     

      2) Is a modifier that indicates whether the method "belongs" to a variable.
         ...
         methods that aren't static won't have static in the header, and some examples are:
         .length() or .nextInt()
      ...
      3) Determines what kind of data our method will output. 
         ...
         public String add_e_to_end_of_String()
         {

         }
  
         The String in the method header indicates the method will return a String value,
         and a method can only return one thing of the determined type.
  
      4) The name of the method.
         We don't capitalize the first character of any method name,
         and we try to make our method names informative as to what they actually do.
  
      5) These are our parameters which are the inputs into our method. This is data that our method needs to work. 
      ...
      */
      ...
      When we use this specific syntax, Java knows to execute the body of the method
      ...
      */
      ...
      This is because those concepts let us perform the task for *any* box. 
      
      Mathematically, parameters are inputs into a function.
  
      Functionally, parameters, and any variables declared inside a method,
      ...
      If we use variables as parameters for a particular method call,
      copies of those variables are made inside the method. 
  
      The fact that parameters are "local" has a significant drawback.
      It means that we can't use parameters to get values out of a method
      ...
      When you are ready to return a value you must use the keyword return
      followed by the value you wish to return.

      This will immediately stop your method at this point
      and return the value back to where the method was originally called.
      */
      ...
      */
      ...
      Methods are very picky about their parameters.
      If a method only accepts integers as an input, and we give it a double, we'll have issues.
      ...
      */
      ...
      Under this framework, we can see it's really important to understand
      that methods are flexible and really the building blocks of programs. 
      */
    ...
    0) Write a method that divides two integers and returns a double indicating the exact result.

    1) Write a method that takes in a String as a parameter and returns the first character
