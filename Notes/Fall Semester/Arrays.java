...
public class Arrays {
  public static void main(String[] args) {
    /*
    As we continue to build more complex programs using loops,
    we might run into the following problem:
    ...
    */
    ...
    /*
    The ability to easily access any element of an array lets us
