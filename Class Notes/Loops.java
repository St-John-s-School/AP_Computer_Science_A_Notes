public class Loops
{
  ...
  {
    /*
    So far, we've focused on programming problems do something a specific number of times (usually once).
    ...
    This construct is a "while loop", and it is going to save us a lot of time and typing.
